 ...
 *     footer: (top) => top.type === 'beraterInnen'
 *       ? { label: …, onClick: () => … }
 *       : undefined,
 *   });
 *
 ...
 *   …
 *   crud.beraterInnen.openCreate({ …defaults })   // create dialog, prefilled — defaults are
 *                                       // shape-tolerant: bare lookup keys / record ids are fine
 *   crud.beraterInnen.openEdit(record)            // edit dialog (recordId + defaults wired)
 *   crud.beraterInnen.openDetail(record)          // record overlay — pass the RAW record,
 *                                       // enrichment is resolved inside
 *   crud.overlay                         // RecordOverlayStack<OverlayItem> for drills:
 *                                       // push / pop / replace / close
 *   crud.enriched.beraterInnen              // the display-ready array for EVERY entity —
