...
export const APP_IDS = {
  'BERATER/INNEN': '6aa2732961edefefe81f0158',
...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  ...
  'rechnungen': {
    rechnungsstatus: [{ key: "offen", get label() { return lookupLabel('rechnungen', 'rechnungsstatus', "offen") ?? "Offen"; } }, { key: "bezahlt", get label() { return lookupLabel('rechnungen', 'rechnungsstatus', "bezahlt") ?? "Bezahlt"; } }, { key: "storniert", get label() { return lookupLabel('rechnungen', 'rechnungsstatus', "storniert") ?? "Storniert"; } }, { key: "ueberfaellig", get label() { return lookupLabel('rechnungen', 'rechnungsstatus', "ueberfaellig") ?? "Überfällig"; } }],
