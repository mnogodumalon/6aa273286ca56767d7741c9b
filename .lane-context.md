...
- `stunden` · number · Geleistete Stunden · required!
- `monat` · lookup · Abrechnungsmonat · required! · options: januar | februar | maerz | april | mai | juni | juli | august | september | oktober | november | dezember
- `jahr` · text · Abrechnungsjahr · required! · maxLength 4000
- `taetigkeitsbeschreibung` · textarea · Tätigkeitsbeschreibung
- `verrechenbar` · bool · Verrechenbar
- `notizen` · textarea · Notizen
- `berater` · record · Berater/in · required! · → `berater/innen`
...
- `rechnungsstatus` · lookup · Rechnungsstatus · required! · options: bezahlt | storniert | ueberfaellig | offen
- `abrechnungsmonat` · lookup · Abrechnungsmonat · options: januar | februar | maerz | april | mai | juni | juli | august | september | oktober | november | dezember
- `abrechnungsjahr` · text · Abrechnungsjahr · maxLength 4000
- `nettobetrag` · number · Nettobetrag (€) · currency
- `mehrwertsteuer` · number · Mehrwertsteuer (%)
- `gesamtbetrag` · number · Gesamtbetrag (€) · required! · currency
- `zahlungseingang` · date · Zahlungseingang
- `leistungspositionen` · textarea · Leistungspositionen
- `notizen` · textarea · Notizen
- `rechnungsdatei` · file · Rechnungsdokument (PDF) · read-only
- `kunde` · record · Kunde · required! · → `kunden`
- `projekt` · record · Projekt · required! · → `projekte`
- `berater` · multirecord · Beteiligte Berater/innen · → `berater/innen`
...
- `projektart` · lookup · Projektart · required! · options: entwicklung | schulung | konzeption | support | sonstiges | it_beratung
- `projektstart_jahr` · text · Startjahr · required! · maxLength 4000
...
- `status` · lookup · Projektstatus · required! · options: in_bearbeitung | akquise | abgeschlossen
...
- `projektende` · date · Geplantes Projektende
- `notizen` · textarea · Notizen
- `kunde` · record · Kunde · required! · → `kunden`
- `projektleitung` · record · Projektleitung · → `berater/innen`
Input shapes: choice `projektart` (ChoiceGroup); choice `status` (ChoiceGroup)

### `leistungskatalog` — Leistungskatalog (type `Leistungskatalog`, one record: `LeistungskatalogEntry`)
Display fields: `leistungsbezeichnung`
- `berater` · multirecord · Ausführende Berater/innen · → `berater/innen`
- `leistungsbezeichnung` · text · Leistungsbezeichnung · required! · maxLength 4000
...
- `stundensatz_leistung` · number · Stundensatz für diese Leistung (€/h) · currency
- `einheit` · lookup · Abrechnungseinheit · options: stunde | tag | pauschal | monat
- `verfuegbarkeit` · textarea · Verfügbarkeit / Hinweise
...
- `kundentyp` · lookup · Kundentyp · required! · options: einzelperson | firma | behoerde | sonstiges
...
- `re_strasse` · text · Rechnungsstraße · maxLength 4000
- `re_hausnummer` · text · Rechnungs-Hausnummer · maxLength 4000
- `re_plz` · text · Rechnungs-Postleitzahl · maxLength 4000
- `re_ort` · text · Rechnungs-Ort · maxLength 4000
- `anlagedatum` · date · Anlagedatum
- `ap_titel` · text · Titel Ansprechpartner · maxLength 4000
- `ap_vorname` · text · Vorname Ansprechpartner · maxLength 4000
- `ap_nachname` · text · Nachname Ansprechpartner · maxLength 4000
- `ap_email` · email · E-Mail Ansprechpartner
- `ap_telefon` · tel · Telefon Ansprechpartner
- `bevorzugte_kontaktart` · lookup · Bevorzugte Kontaktart · options: email | telefon | post | persoenlich
- `letzter_kontakt_datum` · date · Datum letzter Kontakt
- `letzter_kontakt_ansprechpartner` · text · Ansprechpartner beim letzten Kontakt · maxLength 4000
- `notizen` · textarea · Notizen
- `laufende_projekte` · multirecord · Aktuell laufende Projekte · → `projekte`
Input shapes: choice `kundentyp` (ChoiceGroup); choice `bevorzugte_kontaktart` (ChoiceGroup)

### `berater/innen` — Berater/innen (type `BeraterInnen`, one record: `BeraterInnenEntry`)
...
- `sonstiges_1` · textarea · Sonstige Anmerkungen (1)
- `sonstiges_2` · textarea · Sonstige Anmerkungen (2)
...
- `leistungen` · multirecord · Erbringbare Leistungen · → `leistungskatalog`
- `projekte` · multirecord · Aktuell zugewiesene Projekte · → `projekte`
Input shapes: choice `status` (ChoiceGroup)

### `angebote` — Angebote (type `Angebote`, one record: `AngeboteEntry`)
Display fields: `angebotsnummer`
- `kunde` · record · Kunde · → `kunden`
- `angebotsnummer` · text · Angebotsnummer · required! · maxLength 4000
- `angebotsjahr` · text · Jahr · required! · maxLength 4000
- `angebotstyp` · lookup · Angebotstyp · required! · options: dienstleistung | projekt | wartung | schulung | sonstiges
- `angebotsdatum` · date · Angebotsdatum · required!
- `gueltig_bis` · date · Gültig bis
- `zeitrahmen_anfang` · date · Beginn
- `zeitrahmen_ende` · date · Ende (falls vorhanden)
- `dauer` · text · Dauer · maxLength 4000
- `kostentyp` · lookup · Kostentyp · options: einmalig | monatlich | jaehrlich | nach_aufwand | pauschal | sonstiges
- `kostenbetrag` · number · Betrag (€) · currency
- `kosten_beschreibung` · textarea · Kostenbeschreibung
- `angebotsbeschreibung` · textarea · Angebotsbeschreibung
- `leistungspositionen` · textarea · Leistungspositionen
- `anmerkungen` · textarea · Anmerkungen / Sonstiges
- `vorlage_datei` · file · Angebotsvorlage (PDF/Dokument) · read-only
- `projekt` · record · Zugewiesenes Projekt · → `projekte`
- `angebotsstatus` · lookup · Angebotsstatus · required! · options: offen | gesendet | angenommen | abgelehnt | standard_offen
Input shapes: choice `angebotstyp` (ChoiceGroup); choice `kostentyp` (ChoiceGroup); choice `angebotsstatus` (ChoiceGroup)
